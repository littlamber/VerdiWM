...
| Probe information/collision evidence export | `wmloop/experiments/probe_information.py`, `scripts/export/probe_information_and_collision.py` | S4 report is partial: two replay conditions and four redundancy-smoke comparisons are retained; random expansion and collision ground truth remain open |
