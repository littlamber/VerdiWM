...
class ResearchSystem:
    ...
    def run_cycle(self, *, objective: str, constraints: list[str] | None = None) -> dict[str, Any]:
        ...
        def worker(job: ExperimentJob) -> dict[str, Any]:
            ...
            intervention = self.bindings.model.intervene(payload)
            return self.bindings.model.evaluate(intervention, metric_plan.heldout_split)
        ...
        for item in scheduled:
            ...
            evidence.append(graph.append(Evidence(
                ...
                verifier_digest=canonical_digest({"evaluator": capability.evaluator_id, "split": metric_plan.heldout_split}),
